...
const resources = {
  en: {
    ...
    "brain" : "Brainstorming (UX Workshop, User Survey, etc.)",
    ...
    "BA" : "Business Analyst / PPO",

    "result" : "THE RESULT",
    "yourNeeds1" : "Your needs are best met by a ",
    "yourNeeds2" : ".",
    "yourNeeds3" : "Feel free to contact me !",
  ...
  fr: {
    ...
    "BA" : "Business Analyste / PPO",

    "result" : "LE RÉSULTAT",
    "yourNeeds1" : "Vos besoins seront satisfaits au mieux par un ",
    "yourNeeds2" : ". ",
    "yourNeeds3" : "N'hésitez pas à me contacter !",
    "describe" : "Votre besoin",
